// This file contains the combo definitions for the Artsey keyboard layout.
// It defines various combos that can be triggered by pressing specific key combinations.
enum combo_events { ARTSEY_H, ARTSEY_Q, ARTSEY_U, ARTSEY_C, ARTSEY_K, ARTSEY_B, ARTSEY_W, ARTSEY_N, ARTSEY_F, ARTSEY_X, ARTSEY_J, ARTSEY_M,
    ARTSEY_P, ARTSEY_V, ARTSEY_L, ARTSEY_Z, ARTSEY_D, ARTSEY_G, ARTSEY_SPACE, ARTSEY_SPACE_2, ARTSEY_BACKSPACE, ARTSEY_BACKSPACE_2,
    ARTSEY_DEL, ARTSEY_DEL_2, ARTSEY_ENTER, ARTSEY_ENTER_2, ARTSEY_ESCAPE, ARTSEY_ESCAPE_2, ARTSEY_QUOTE, ARTSEY_BANG, ARTSEY_QUEST,
    ARTSEY_PERIOD, ARTSEY_COMMA, ARTSEY_SLASH, ARTSEY_TAB, ARTSEY_OS_SHIFT, ARTSEY_CTRL, ARTSEY_CTRL_2, ARTSEY_CTRL_3, ARTSEY_GUI,
    ARTSEY_GUI_2, ARTSEY_GUI_3, ARTSEY_ALT, ARTSEY_ALT_2, ARTSEY_ALT_3, ARTSEY_SHIFT, ARTSEY_SHIFT2, ARSEY_PANIC, ARSEY_PANIC_2,
    ARSEY_PANIC_3, ARTSEY_NAV, ARTSEY_MAIN1, ARTSEY_MOU, ARTSEY_MAIN2, ARTSEY_7, ARTSEY_8, ARTSEY_9, ARTSEY_0, COMBO_LENGTH
};
...
// This array defines the combos and their corresponding actions.
combo_t key_combos[] = {
...
// This function is called when a combo is triggered
// and the combo index is passed as an argument.
// The pressed argument indicates whether the combo was pressed or released.
