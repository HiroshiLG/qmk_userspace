...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT, KC_Z,  KC_X,     KC_C,     KC_V,     KC_B,       KC_MUTE,     RGB_TOG,  KC_N,      KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT,
                  KC_LCTL,  KC_LGUI,  KC_LALT,  KC_LOWER,   KC_SPC,      KC_ENT,   KC_RAISE,  KC_RALT,  KC_RGUI,  KC_RCTL
),
...
[_LOWER] = LAYOUT(
  ...
  KC_GRV,  RALT(KC_MINS),  RALT(KC_Q),  XXXXXXX,   XXXXXXX,  XXXXXXX,                            KC_1,       KC_2,    KC_3,    KC_PMNS,   KC_QUOT,       KC_BSLS,
...
[_RAISE] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX,    XXXXXXX,    XXXXXXX,   XXXXXXX,  XXXXXXX,                         KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,
